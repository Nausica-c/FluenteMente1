...
Ordinare al ristorante è facile, ma cosa succede quando vuoi fare due chiacchiere con qualcuno in un ostello o al bancone di un bar? Iniziare con *"How are you? I am fine"* ti farà sembrare un libro di testo datato. 

Se viaggi da solo, vuoi fare nuove amicizie o speri in un incontro speciale, devi imparare l'arte dello **Small Talk**.

<div class="in-breve-box" style="border-left-color: #3b82f6; background-color: #f0f9ff; color: #1e3a8a;">
  <strong>💡 Prima di socializzare:</strong> Se ti serve prima un ripasso per superare la logistica, <strong><a href="{{ '/inglese/viaggio/kit-30-frasi-inglese-viaggio/' | relative_url }}">scarica il nostro Kit 30 Frasi Salva-Vita</a></strong> da tenere sul telefono.
</div>
